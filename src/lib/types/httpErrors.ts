...
export const ErrorCodes: Array<{ code: ErrorCode; name: string; description: string }> = [
	...
	{
		code: HttpErrors.CREATED,
		name: 'Created',
		description: 'The request has been fulfilled and resulted in a new resource being created.'
	},
	{
		code: HttpErrors.NO_CONTENT,
		name: 'No Content',
		description: 'The server successfully processed the request and is not returning any content.'
	},
	{
		code: HttpErrors.BAD_REQUEST,
		name: 'Bad Request',
	...
	{
		code: HttpErrors.BAD_GATEWAY,
		name: 'Bad Gateway',
		description:
			'The server was acting as a gateway or proxy and received an invalid response from the upstream server.'
	},
	{
		code: HttpErrors.SERVICE_UNAVAILABLE,
